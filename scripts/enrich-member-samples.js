...
function renderHeader() {
  return [
    ...
    "",
    "#define SAMPLE_DEVICE_STATE_VALUE 42",
    "#define SAMPLE_DEVICE_STATE_IN g_member_state.counter",
    "#define SAMPLE_DEVICE_STATE_OUT mode",
    "",
    ...
    "void StructMember_DEFINE(SAMPLE_DEVICE_STATE *state);",
    "",
    "#endif",
    ""
  ].join("\n");
...
function renderSource() {
  return [
    ...
    "    StructMember_DEFINE(&g_member_state);",
    ...
    "void StructMember_DEFINE(SAMPLE_DEVICE_STATE *state)",
    "{",
    "    state->SAMPLE_DEVICE_STATE_OUT = SAMPLE_DEVICE_STATE_IN;",
    "}",
    ""
  ].join("\n");
}
